...
export const PROJECTS: ProjectItemProps[] = [
	...
	},
	{
		...
		description: "Todo Application with calender and time tracker",
		link: "/todo",
		type: "web",
		tools: ["React", "HTML", "CSS", "Ant Design", "Tailwind CSS"],
		codeUrl: "https://github.com/Okoli-Ryan/modern-todo-app",
		liveUrl: "https://modern-todo-app-ten.vercel.app/",
	},
	{
