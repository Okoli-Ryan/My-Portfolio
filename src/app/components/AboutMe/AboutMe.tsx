...
export default function AboutMe() {
	return (
		<div className="container flex gap-8 flex-col bottom-border py-16" id="about">
			<h2 className="text-5xl font-bold text-center font-mono">About Me</h2>
			<p className="leading-8 font-sans text-center max-w-lg w-full mx-auto mb-8 mt-4">
				Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology
			</p>
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
				<div className="flex flex-col gap-8">
					<h3 className="text-white text-2xl font-bold text-center lg:text-left">Get To Know me!</h3>
